...
[The Junctions Router](https://junctions.js.org) was originally designed in response to the requirements of a  production React application. And as it turns 
out, these same requirements can be summarised as a haiku.
